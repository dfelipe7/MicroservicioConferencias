...
/**
 * Controlador REST para gestionar las conferencias académicas.
 * Proporciona endpoints para crear, actualizar, eliminar y obtener conferencias. 
 * Este controlador se comunica con el microservicio de sesión para validar 
 * el rol y permisos del usuario, asegurando que solo los usuarios con rol 
 * de "Organizador" puedan realizar ciertas operaciones.
...
public class ConferenceController {
     ...
     * 
     * @param conference el objeto {@link Conference} con la información de la conferencia a crear
     ...
     * @return la conferencia si se encuentra, o un estado 404 si no se encuentra
     */
    @GetMapping("/{id}")
    ...
    /**
     * Endpoint para actualizar una conferencia existente. Solo los organizadores
     * pueden realizar esta operación y deben ser el creador de la conferencia.
     * 
